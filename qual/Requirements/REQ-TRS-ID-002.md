...
The tool **shall** validate that every element with `type: TestCase` carries an `id:` field matching the pattern `^TC(-[A-Z0-9]{2,12})+-[0-9]{3}$`. Failure to match **shall** produce error `E006`.
